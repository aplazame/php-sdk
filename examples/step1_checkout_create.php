...
function createCheckoutPayload() {
    ...
    $merchant->notification_url = 'https://merchant.com/order/step3_checkout_confirm.php'; // url where you will receive Aplazame webhook events as described in https://aplazame.dev/en/docs/api/checkout-confirmation/ or https://aplazame.dev/docs/api/checkout-confirmation/
 ...
 * @param array|object $payload Checkout Parameters as described in https://aplazame.dev/en/docs/api/checkout-process/ or https://aplazame.dev/docs/api/checkout-process/
 *
...
{
    try {
        return $aplazameApiClient->request('POST','/checkout', $payload, 4)['id'];
